...
var imageAR = document.getElementsByTagName("img");

var _loop = function _loop(_x) {
  imageAR[_x].addEventListener("click", function () {
    imageAR[_x].classList.toggle("imageSelected");
  });
};

for (var _x = 0; _x < imageAR.length; _x++) {
  _loop(_x);
}
